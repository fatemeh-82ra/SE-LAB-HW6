...
//    }
    ...
    public void call() {
        ...
        Address temp = new Address(memory.allocateAddreds(), t);
        ss.push(temp);
...
//        }
    ...
    public void add() {
        Address temp = new Address(memory.allocateAddreds(), varType.Int);
        Address s2 = ss.pop();
        Address s1 = ss.pop();
...
//        memory.saveMemory();
    ...
    public void equal() {
        Address temp = new Address(memory.allocateAddreds(), varType.Bool);
        Address s2 = ss.pop();
        Address s1 = ss.pop();
        if (s1.varType != s2.varType) {
